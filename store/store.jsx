let store = {
	...
	headerPages: [
		...
		{
			id: 2, title: "About Us", href: "/about", seo: {
				description: "Management. Survey. Registration.",
				pageTitle: "About us",
				siteTitle: "Mediterranean Shipping Register"
			},
			...
			pages: [
				{
					id: 1, title: "About Our Mission", href: "/about/mission", seo: {
				...
				{
					id: 2, title: "About Our Policy", href: "/about/policy", seo: {
				...
				{
					id: 3, title: "About Our Geography", href: "/about/geography", seo: {
		...
		{
			id: 3, title: "Contact", href: "/contact", seo: {
				description: "Management. Survey. Registration.",
				pageTitle: "Contact",
				siteTitle: "Mediterranean Shipping Register"
			}
	...
	asidePages: [
		{
			id: 1, title: "Ship Classification", href: "/services/ship-classification",
			seo: {
		...
		{
			id: 2, title: "Statutory services", href: "/services/statutory-services",
			seo: {
		...
		{
			id: 3, title: "Surveys", href: "/services/surveys",
			seo: {
				description: "Surveys.",
				pageTitle: "Surveys",
				siteTitle: "Mediterranean Shipping Register"
		...
		{
			id: 4, title: "Towage", href: "/services/towage",
			seo: {
				description: "Towage.",
				pageTitle: "Towage",
				siteTitle: "Mediterranean Shipping Register"
		...
		{
			id: 5, title: "Certification", href: "/services/certification",
			seo: {
		...
		{
			id: 6, title: "Advisory & Consulting", href: "/services/advisory-and-consulting",
			seo: {
		...
		{
			id: 7, title: "Useful Information", href: "/services/information",
			seo: {
