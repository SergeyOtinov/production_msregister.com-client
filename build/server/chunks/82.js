...
const API_URL = 'https://www.msregister.com:5000/api/'; // export const API_URL = 'http://localhost:5000/api/'
...
;// CONCATENATED MODULE: ./src/services/RequestServices.js

const RequestServices_$api = external_axios_default().create({
  headers: {
...
class RequestService {
  static async requestElma(requestBody) {
    return RequestServices_$api.post('/', {
      requestBody
    });
  }
...
class Store {
  ...
  async requestElma(requestBody) {
    try {
      ...
      return (_e$response12 = e.response) === null || _e$response12 === void 0 ? void 0 : (_e$response12$data = _e$response12.data) === null || _e$response12$data === void 0 ? void 0 : _e$response12$data.message;
    }
  }
